...
extension UITextField {
    ...
    func setPlaceHolder(_ title: String = "", _ font: UIFont = UIFont.boldFont(ofSize: 18), _ color: UIColor = .gray) {
        self.attributedPlaceholder = NSAttributedString(string: localizedText(title),attributes: [NSAttributedString.Key.foregroundColor: color, NSAttributedString.Key.font: font])
    }
}
