...
extension UIButton {
    ...
    func btnDefault(cornerRadius: CGFloat? = 6, color: UIColor? = .secondary, titleKey: String? = nil) {
    ...
    func btnDefaultWithBorder(cornerRadius: CGFloat? = 6, color: UIColor? = .secondary, titleKey: String? = nil) {
